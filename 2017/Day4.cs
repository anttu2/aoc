...
namespace AdventOfCode
{
    public class Day4
    {
        ...
        public void TestInput1_Part1(string passphrase, bool isValid)
        {
            Assert.Equal(isValid, IsPassphraseValidPart1(passphrase));
        }

        [Fact]
        public void TestInput2_Part1()
        {
            string input = @"aa bb cc dd ee
aa bb cc dd aa
aa bb cc dd aaa";

            Assert.Equal(2, GetCountOfValidPassphrases(GetPassphrases(input), IsPassphraseValidPart1));
        }

        [Fact]
        public void RealInput_Part1()
        {
            var passphrases = GetPassphrases(RealInput);
            var countOfValidPassphrases = GetCountOfValidPassphrases(passphrases, IsPassphraseValidPart1);

            _output.WriteLine(countOfValidPassphrases.ToString());
        }

        private int GetCountOfValidPassphrases(List<string> passphrases, Func<string, bool> validationMethod)
        {
            var countOfValidPassphrases = passphrases
                .Select(validationMethod)
                .Count(isValid => isValid);
            return countOfValidPassphrases;
        }

        private bool IsPassphraseValidPart1(string passphrase)
        {
            return passphrase
                .Split(" ")
                .GroupBy(p => p)
        ...
        public void TestInput1_Part2(string passphrase, bool isValid)
        {
            Assert.Equal(isValid, IsPassphraseValidPart2(passphrase));
        }
        ...
        {
            var passphrases = GetPassphrases(RealInput);
            var countOfValidPassphrases = GetCountOfValidPassphrases(passphrases, IsPassphraseValidPart2);

            _output.WriteLine(countOfValidPassphrases.ToString());
        }

        private bool IsPassphraseValidPart2(string passphrase)
        {
            return passphrase
                .Split(" ")
        ...
        public List<string> GetPassphrases(string input)
        {
            return input.Split("\r\n").ToList();
        }
        
        const string RealInput = @"oaoe rxeq vssdqtu xrk cjv yaoqp loo
